<template>
    <b-container fluid>
        <b-row class="px-3 pt-3">
                ...
                <b-form>
                    <b-row>
                        <b-col cols="12" class="d-flex justify-content-between align-items-center">
                            ...
                            <b-button data-cy="button-save-supplier" class="step-button" v-b-popover.hover.left="'Guardar'" :disabled="$v.$invalid"
                                @click="$bvModal.show('save-supplier-confirmation')">
                                ...
                                <b-row class="p-4 justify-content-center">
                                    <b-col cols="12" lg="7" order="2" order-lg="1">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-name" id="name" type="text" placeholder="Nombre..." maxlength="50"
                                        ...
                                        <b-form-group>
                                            ...
                                            <b-form-textarea data-cy="input-save-supplier-description" id="description" placeholder="Descripción..." rows="4"
                                        ...
                                        <b-form-group>
                                            ...
                                            <div class="image-selector-container" @click="triggerFileInput"
                                                ...
                                                <template>
                                                    ...
                                                    <input data-cy="input-save-supplier-image" type="file" id="image-selector-container" ref="fileInput"
                                                ...
                                                <template>
                                                    <div class="selected-image">
                                                        ...
                                                        <div class="icon-remove">
                                                            <b-button data-cy="button-save-supplier-remove-image" variant="danger" size="sm" class="btn btn-rounded"
                                                                @click="removeImage"
                                ...
                                <b-row class="p-4">
                                    ...
                                    <b-col cols="10">
                                        <b-form-group>
                                            <label for="contactName">Nombre de contacto: <b
                                                    class="text-danger">*</b></label>
                                            <b-form-input data-cy="input-save-supplier-contact-name" id="contactName" type="text"
                                    ...
                                    <b-col cols="10">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-email" id="email" type="email" placeholder="Correo electrónico..."
                                    ...
                                    <b-col cols="4" lg="2">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-lada" id="lada" type="text" placeholder="Lada..." maxlength="3"
                                    ...
                                    <b-col cols="6" lg="8">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-phone" id="phone" type="text" placeholder="Teléfono..."
                                ...
                                <b-row class="p-4">
                                    <b-col cols="12" sm="6" lg="4">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-country" id="country" type="text" placeholder="País..." maxlength="50"
                                    ...
                                    <b-col cols="12" sm="6" lg="4">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-state" id="state" type="text" placeholder="Estado..." maxlength="50"
                                    ...
                                    <b-col cols="12" sm="6" lg="4">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-city" id="city" type="text" placeholder="Ciudad..." maxlength="50"
                                    ...
                                    <b-col cols="12" sm="6" lg="4">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-colony" id="colony" type="text" placeholder="Colonia..."
                                    ...
                                    <b-col cols="12" sm="6" lg="4">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-street" id="street" type="text" placeholder="Calle..." maxlength="50"
                                    ...
                                    <b-col cols="12" sm="6" lg="4">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-postal-code" id="postalCode" type="text" placeholder="00000" maxlength="5"
                                    ...
                                    <b-col cols="6" lg="3">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-exterior-number" id="exteriorNumber" type="text" placeholder="0" maxlength="4"
                                    ...
                                    <b-col cols="6" lg="3">
                                        <b-form-group>
                                            ...
                                            <b-form-input data-cy="input-save-supplier-interior-number" id="interiorNumber" type="text" placeholder="0" maxlength="4"
                                    ...
                                    <b-col cols="12" lg="6">
                                        <b-form-group
                                            ...
                                            <multiselect data-cy="multiselect-save-supplier-building-type" :config="multiselectConfig"
                                    ...
                                    <b-col cols="12">
                                        <b-form-group>
                                            ...
                                            <b-form-textarea data-cy="input-save-supplier-reference-details" id="referenceDetails" placeholder="Referencias..." rows="3"
                        ...
                        <b-col cols="12" class="mt-3 d-flex justify-content-end">
                            <b-button data-cy="button-supplier-stepper-cancel" variant="secondary" class="button-actions"
                                @click="$router.push({ name: 'suppliers' })">
                                Cancelar
                            </b-button>
                            <b-button data-cy="button-supplier-stepper-previous" variant="primary" class="button-actions ml-2" @click="step--" v-if="step > 1">
                                Anterior
                            </b-button>
                            <b-button data-cy="button-supplier-stepper-next" variant="primary" class="button-actions ml-2" @click="step++"
            ...
            <confirmation-modal :config="confirmationConfig" @onConfirm="saveSupplier" />
        </b-row>
    </b-container>
</template>
...
export default Vue.extend({
    ...
    data() {
        return {
            ...
            confirmationConfig: {
                id: 'save-supplier-confirmation',
                type: 'question',
                title: 'Registrar proveedor',
                message: '¿Estás seguro de registrar este proveedor?',
    ...
    methods: {
        ...
        async saveSupplier() {
            try {
                ...
                const response = await controller.saveSupplier(this.supplier);
                if (response.status == 201) {
                    showSuccessToast('Proveedor registrado');
                ...
                this.$bvModal.hide('save-supplier-confirmation');
            }
        }
    },
    validations: {
